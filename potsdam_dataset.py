...
class PotsdamDataset(Dataset):
    ...
    def __init__(self, data_root='datatest/potsdam/test', mode='val', img_dir='images_1024', mask_dir='masks_1024',
                 img_suffix='.tif', mask_suffix='.png', transform=val_aug, mosaic_ratio=0.0,
                 img_size=ORIGIN_IMG_SIZE):
    ...
    def get_img_ids(self, data_root, img_dir, mask_dir):
        ...
        # 修改日期2023.4.26
        img_filename_list = os.listdir(osp.join(data_root, img_dir).replace("\\","/"))
